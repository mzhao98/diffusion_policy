...
class DiffusionUnetLowdimPolicy(BaseLowdimPolicy):
    ...
    def compute_loss_with_cfg(self, batch):
        ...
        # batch_traj_indices = batch['idx']
        # pdb.set_trace()
        context_cond = batch_traj_indices
        # pdb.set_trace()
        ...
        ##############################################
        pred_without_class = self.model(noisy_trajectory, timesteps,local_cond=local_cond, global_cond=global_cond, 
                                     context_cond=None)
        ##############################################
